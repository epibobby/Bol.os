...
**
** Created: Thu 23. Feb 11:08:45 2012
...
public:
    ...
    void setupUi(QWidget *AutoShutdown)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("D:/images/shutdown.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("D:/images/restart.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("D:/images/veille.gif"), QSize(), QIcon::Normal, QIcon::Off);
        Sleep->setIcon(icon2);
