...
**
** Created: Sun 15. Apr 23:01:52 2012
...
void JsonParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData JsonParser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject JsonParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_JsonParser,
      qt_meta_data_JsonParser, &staticMetaObjectExtraData }
};
