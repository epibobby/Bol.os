...
**
** Created: Sun 15. Apr 23:01:29 2012
...
static const char qt_meta_stringdata_Alert[] = {
    "Alert\0\0on_pushButton_clicked()\0"
};
...
const QMetaObjectExtraData Alert::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Alert::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Alert,
      qt_meta_data_Alert, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Alert::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Alert))
