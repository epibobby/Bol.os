...
**
** Created: Mon 13. Feb 14:36:17 2012
...
public:
    ...
    void retranslateUi(QDialog *ConnectionSettings)
    {
        ...
        Server->setText(QApplication::translate("ConnectionSettings", "10.17.70.141", 0, QApplication::UnicodeUTF8));
        Port->setText(QApplication::translate("ConnectionSettings", "4242", 0, QApplication::UnicodeUTF8));
